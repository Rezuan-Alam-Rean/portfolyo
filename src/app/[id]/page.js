...
const Details = ({ params }) => {
    ...
    return (
        <div>
                ...
                <h1 className='mt-12 mb-10 text-4xl text-red-500 text-center font-bold' >Project Details </h1>
            ...
            {project ? (
                <div className='w-full' >
                    ...
                    <div className=" mt-10 mb-10 px-10   bg-white w-[70%] mx-auto h-screen rounded-xl shadow-md overflow-hidden md:flex-row ">
                        <div className=" ">
                            <img className=" h-96   w-full object-cover" src={project.image.url} alt={project.title} layout="fill" />
                        </div>
                        <div className="p-8">
                            <div className="uppercase tracking-wide  text-black text-3xl font-semibold">{project.title}</div>
