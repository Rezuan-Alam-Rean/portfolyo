    ...
    return (
        ...
        <div>
            ...
            <div className="text-center">
                <p className='font-bold text-4xl mt-5 mb-4'> <span className='text-red-400' >My</span>  Services</p>
                <h2 className='font-mono' >I Provide Wide Range Of Digital Services</h2>
            </div>

            <div className=" grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 px-6 mt-10  gap-5 max-w-7xl mx-auto   ">
